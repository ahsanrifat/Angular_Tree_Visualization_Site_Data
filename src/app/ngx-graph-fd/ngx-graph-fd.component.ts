...
@Component({
  selector: 'app-ngx-graph-fd',
  templateUrl: './ngx-graph-fd.component.html',
  styleUrls: ['./ngx-graph-fd.component.css'],
})
export class NgxGraphFdComponent implements OnInit {
